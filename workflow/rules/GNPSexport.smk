...
rule MapAlignerPoseClustering:
    ...
    shell:
        """
        /nfs/wsi/abi/scratch/alka/openms/openms_build/bin/MapAlignerPoseClustering -algorithm:max_num_peaks_considered -1 -in {input} -out {output.var1} -trafo_out {output.var2}
        """ 
...
rule IDMapper:
    ...
    shell:
        """
        /nfs/wsi/abi/scratch/alka/openms/openms_build/bin/IDMapper -id {input.var1} -in {input.var2}  -spectra:in {input.var3} -out {output} 
        """
...
rule FileFilter:
    ...
    shell:
        """
        /nfs/wsi/abi/scratch/alka/openms/openms_build/bin/FileFilter -id:remove_unannotated_features -in {input} -out {output} 
        """
...
rule GNPS_export:
    ...
    shell:
        """
        /nfs/wsi/abi/scratch/alka/openms/openms_build/bin/GNPSExport -ini resources/GNPSExport.ini -in_cm {input.var1} -in_mzml {input.var2} -out {output} 
        """
