...
#CSI:FingerID: The CSI_fingerID function is another algorithm from the Boecher lab, just like SIRIUS adapter and it is using MS2 data and the formula predictions from SIRIUS, to predict structures.
